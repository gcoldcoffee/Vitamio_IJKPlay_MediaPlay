  ...
  public MediaPlayer(Context ctx, boolean preferHWDecoder) {
    ...
    if (preferHWDecoder) {
      ...
      try {
        ...
        ALog.e("unloadOMX failed %s", e.toString());
      }
  ...
  static {
    ...
    try {
      ...
      if (!vvo_loaded) {
        ...
        ALog.d("FALLBACK TO VVO JNI " + vvo_loaded);
      }
      loadVAO_native(LIB_ROOT + "libvao.0.so");
    } catch (java.lang.UnsatisfiedLinkError e) {
      ALog.e("Error loading libs", e);
    }
  }
    ...
    public void handleMessage(Message msg) {
      switch (msg.what) {
        ...
        case MEDIA_SET_VIDEO_SIZE:
          ...
          return;
        case MEDIA_ERROR:
          ALog.e("Error (%d, %d)", msg.arg1, msg.arg2);
          ...
          return;
        case MEDIA_INFO:
          ALog.i("Info (%d, %d)", msg.arg1, msg.arg2);
        ...
        case MEDIA_TIMED_TEXT:
          ...
          if (mData.getInt(MEDIA_SUBTITLE_TYPE) == SUBTITLE_TEXT) {
            ALog.i("Subtitle : %s", mData.getString(MEDIA_SUBTITLE_STRING));
        ...
        case MEDIA_HW_ERROR:
        	...
        	return;
        default:
          ALog.e("Unknown message type " + msg.what);
          return;
      }
    }
  }
