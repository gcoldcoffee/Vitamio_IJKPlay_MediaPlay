...
public class MediaScanner {
  ...
  public void scanDirectories(String[] directories) {
    try {
      ...
      ALog.d(" prescan time: %dms", prescan - start);
      ALog.d("    scan time: %dms", scan - prescan);
      ALog.d("postscan time: %dms", end - scan);
      ALog.d("   total time: %dms", end - start);
    } catch (SQLException e) {
      ALog.e("SQLException in MediaScanner.scan()", e);
    } catch (UnsupportedOperationException e) {
      ALog.e("UnsupportedOperationException in MediaScanner.scan()", e);
    } catch (RemoteException e) {
      ALog.e("RemoteException in MediaScanner.scan()", e);
    }
  }
  ...
  public Uri scanSingleFile(String path, String mimeType) {
    try {
      ...
      ALog.e("RemoteException in MediaScanner.scanFile()", e);
      return null;
    }
  }
  ...
  private class MyMediaScannerClient implements MediaScannerClient {
    ...
    public void handleStringTag(String name, byte[] valueBytes, String valueEncoding) {
      ...
      try {
        ...
        ALog.e("handleStringTag", e);
        value = new String(valueBytes);
      }
      ALog.i("%s : %s", name, value);
